...
public class Grid {
    public static void main(String[] args) {
        ...
        try {
            Scanner scFile = new Scanner(new File(inputFile));
            ...
            for(int d = 0; d < c; d++){
                if (! grid[k][d]){
                    for(int x = 0; x < numShapes; x++){
                        if (shapes[x].quant > 0 && shapes[x].id != 24){
                            Shape now = shapes[x];
                            int [][] temp0 = now.or0;
                            int [][] temp1 = now.or1;
                            int [][] temp2 = now.or2;
                            ...
                            if(flag1){
                                ...
                                file.write(out.substring(0, out.length()-1) + "\n");  
                                now.quant--;
                                break;
                            }
                            flag1 = true;
        ...
        for(int k = 0; k < r; k++){
            for(int d = 0; d < c; d++){
                if(!grid[k][d] && shapes[index].quant > 0){
                    Shape now = shapes[index];
                    String out = now.id + "|";
